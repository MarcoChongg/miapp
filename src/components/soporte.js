...
function Chatroom(){
    ...
    const dummy = useRef()
    const messageRef = firestore.collection("soporte"+auth.currentUser.uid)
    ...
    if(auth.currentUser.uid != "c2cXo7RJ17YpIgfovRDhnRVhxvJ2"){
                ...
                <div className="card-header msg_head">
                  <div className="d-flex bd-highlight">
                    <div className="img_cont">
                      <img src={"https://media.istockphoto.com/vectors/technical-support-icon-vector-id1257682822"} className="rounded-circle user_img" />
                      <span className="online_icon" />
                    </div>
                    <div className="user_info">
                      <span>Chat with Soporte</span>
                      <p></p>
                    </div>
  ...
  function NewChat(targetuid){
    const messageRef = firestore.collection("soporte"+targetuid)
    return messageRef
  }